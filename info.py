...
API_ID = int(environ.get('API_ID', '20543704'))
API_HASH = environ.get('API_HASH', '08a140d74b8877f396efa2ece072fec3')
BOT_TOKEN = environ.get('BOT_TOKEN', "8360836818:AAGM82w5Is-8uY4C9XUErk5iICyvsuk7IGM")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6532576467').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003821987744'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003855242492').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003636256126') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002607332299')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002607332299')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003792600802')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003810287937').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Abinas:<SfGIkdnGZOREPlNX>@cluster0.w3q6v0y.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "MCMovieCenter")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'MCMcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+rErx7uWOksVhMTc1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+YfidhpwGNks0OWI9')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK', 'https://t.me/MovieCenterAdmin')
...
MSG_ALRT = environ.get('MSG_ALRT', '‼️ FILE NOT FOUND ? ‼️ 
...
YEARS = ["1900", "1991", "1992", "1993", "1994", "1995", "1996", "1997", "1998", "1999", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025","2026"]
                           ...
                           # Don't Remove Credit @MovieCenterAdmin
